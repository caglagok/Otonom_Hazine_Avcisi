...
{
    public class HareketsizEngeller : Engel
    {
        ...
        public HareketsizEngeller(int hucreBoyutu, Panel panel, int kenarBoyutu, string name) : base(hucreBoyutu, "HareketsizEngel")
        {
